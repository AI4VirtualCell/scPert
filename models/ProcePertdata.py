...
class PertData:
    ...
    def load(self, DataName = None, data_path = None):
        ...
        Use DataName for loading 'norman', 'adamson', 'dixit' datasets
        ...
        if DataName in ['norman', 'adamson', 'dixit', 
            ...
            adata_path = os.path.join(data_path, DataName, 'perturb_processed.h5ad')
    ...
    def prepare_split(self, split = 'simulation', 
        ...
        if os.path.exists(split_path):
            ...
            if split in ['simulation', 'simulation_single']:
                ...
                else:  # 'simulation_single'
                    adata = DS.split_data(train_gene_set_size = train_gene_set_size, 
                                        combo_seen2_train_frac = combo_seen2_train_frac,
                                        seed=seed,
                                        test_perts = test_perts,
                                        only_test_set_perts = only_test_set_perts
